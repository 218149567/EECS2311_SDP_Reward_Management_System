...
//		panel.add(nameofuser);
		...
		panel.setLayout(null);
		JLabel Userlabel = new JLabel("Username");//10, 30, 80, 25
		Userlabel.setBounds(10, 30, 80, 25);
		panel.add(Userlabel);
		
		panel.setLayout(null);
		JLabel Passlabel = new JLabel("Password");
		Passlabel.setBounds(10, 70, 80, 25);//10, 70, 80, 25
		panel.add(Passlabel);
...
//		panel.add(nameText);
		...
		startextpass.setBounds(100,70,165,25);//100,70,165,25
		...
		gobackButton.setBounds(140, 140, 80, 25);
